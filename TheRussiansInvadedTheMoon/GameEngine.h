...
//Include iostream in gameengine 
#include <iostream>
...
public:
	...
	bool			DrawRect(RECT2 rect, double strokeWidth);
	bool			DrawRect(DOUBLE2 topLeft, DOUBLE2 rightbottom, double strokeWidth);
	bool			DrawRect(RECT rect);
	bool			DrawRect(int left, int top, int right, int bottom);
	bool			DrawRect(int left, int top, int right, int bottom, double strokeWidth);
